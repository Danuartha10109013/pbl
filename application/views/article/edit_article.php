	...
	<div class="form-group">
		<form action="<?= base_url('article/update_article/' . $article_data['id']); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				...
				<input type="post" class="form-control" id="contens" name="contens" placeholder="Your main contens" value="<?= $article_data['contens']; ?>"></input>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="key" name="key" placeholder="Your key for the article" value="<?= $article_data['key']; ?>">
			</div>
			<div class="mb-3">
